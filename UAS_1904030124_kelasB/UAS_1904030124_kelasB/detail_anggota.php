        ...
        <section class="page-section" id="portfolio">
          <div class="container justify-content-center">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item"><img class="rounded" src="image/<?php echo $anggota['gambar_anggota']; ?>"" width="250px"></li>
              ...
              <li class="list-group-item">
                <a href="hapus.php?id=<?= $anggota['id']; ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini');" class="btn btn-danger" role="button">Hapus</a> | 
